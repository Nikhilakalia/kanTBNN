...
run_name = 'kan_experiment_61_opt'
results_dir = '/home/nikki/kan/kanTBNN/models/multi_run/kan_experiment_61_opt'
...
training_params = {
    ...
    'max_epochs': 8000,
    'learning_rate': 0.005352440657563348,
...
model_params = {
    ...
    'grid': 5,
    'k': 3,
    'input_features': ['komegasst_I1_12', 'komegasst_I1_10', 'komegasst_I1_7', 'komegasst_I1_3', 'komegasst_q6', 'komegasst_q5'],
}
