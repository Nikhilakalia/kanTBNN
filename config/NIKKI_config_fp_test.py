...
# Instantiate the model from tbnn.models.kanTBNN
model = tbnn.models.kanTBNN(
    width=model_params['width'],
    grid=model_params['grid'],
    k=model_params['k'],
    seed=7,  # You can define the seed here
...
model.save_model_as_pickle(os.path.join(results_dir, f'{model.barcode}.pkl'))
# Save using torch
model.save_model_as_torch(os.path.join(results_dir, f'{model.barcode}.pt'))
model.plot()
