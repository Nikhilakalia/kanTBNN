...
run_name = 'kan_experiment_60_opt'
results_dir = '/home/nikki/kan/kanTBNN/models/multi_run/kan_experiment_60_opt'
...
training_params = {
    ...
    'max_epochs': 8000,
    'learning_rate': 0.0024523679037012705,
...
model_params = {
    ...
    'grid': 9,
    'k': 3,
    'input_features': ['komegasst_I1_12', 'komegasst_q6', 'komegasst_I1_9', 'komegasst_q5', 'komegasst_I1_10', 'komegasst_I1_4'],
}
