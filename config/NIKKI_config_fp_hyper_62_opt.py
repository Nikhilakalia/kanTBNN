...
run_name = 'kan_experiment_62_opt'
results_dir = '/home/nikki/kan/kanTBNN/models/multi_run/kan_experiment_62_opt'
...
training_params = {
    ...
    'max_epochs': 8000,
    'learning_rate': 0.006159916713714093,
...
model_params = {
    ...
    'grid': 10,
    'k': 3,
    'input_features': ['komegasst_I1_1', 'komegasst_I1_10', 'komegasst_I1_16', 'komegasst_q6', 'komegasst_q5', 'komegasst_I1_3'],
}
