...
run_name = 'kan_experiment_46_opt'
results_dir = '/home/nikki/kan/kanTBNN/models/multi_run/kan_experiment_46_opt'
...
training_params = {
    ...
    'max_epochs': 8000,
    'learning_rate': 0.001170755892911066,
...
model_params = {
    ...
    'grid': 6,
    'k': 3,
    'input_features': ['komegasst_I1_4', 'komegasst_I1_12', 'komegasst_I1_10', 'komegasst_q6', 'komegasst_I1_3', 'komegasst_q5'],
}
