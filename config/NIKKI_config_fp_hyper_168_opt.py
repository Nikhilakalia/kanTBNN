...
run_name = 'kan_experiment_168_opt'
results_dir = '/home/nikki/kan/kanTBNN/models/multi_run/kan_experiment_168_opt'
...
training_params = {
    ...
    'max_epochs': 8000,
    'learning_rate': 0.0030158928028238574,
...
model_params = {
    ...
    'grid': 9,
    'k': 4,
    'input_features': ['komegasst_I1_1', 'komegasst_I1_7', 'komegasst_I1_16', 'komegasst_q5', 'komegasst_I1_3', 'komegasst_q6'],
}
