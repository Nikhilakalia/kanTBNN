...
run_name = 'kan_experiment_96_opt'
results_dir = '/home/nikki/kan/kanTBNN/models/multi_run/kan_experiment_96_opt'
...
training_params = {
    ...
    'max_epochs': 8000,
    'learning_rate': 0.00011593588606541377,
...
model_params = {
    ...
    'grid': 8,
    'k': 3,
    'input_features': ['komegasst_I1_1', 'komegasst_I1_13', 'komegasst_I1_4', 'komegasst_I1_10', 'komegasst_q6', 'komegasst_q5'],
}
