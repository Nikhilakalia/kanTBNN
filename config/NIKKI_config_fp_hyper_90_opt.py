...
run_name = 'kan_experiment_90_opt'
results_dir = '/home/nikki/kan/kanTBNN/models/multi_run/kan_experiment_90_opt'
...
training_params = {
    ...
    'max_epochs': 8000,
    'learning_rate': 0.00814125797694127,
...
model_params = {
    ...
    'grid': 10,
    'k': 3,
    'input_features': ['komegasst_q5', 'komegasst_I1_13', 'komegasst_I1_16', 'komegasst_q6', 'komegasst_I1_5', 'komegasst_I1_1'],
}
