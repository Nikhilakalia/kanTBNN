...
run_name = 'kan_experiment_1'
results_dir = '/home/nikki/kan/kanTBNN/models/multi_run/kan_experiment_1'
...
training_params = {
    ...
    'max_epochs': 6000,
    'learning_rate': 0.005417566793262436,
...
model_params = {
    ...
    'grid': 4,
    'k': 3,
    'input_features': ['komegasst_q5', 'komegasst_I1_13', 'komegasst_I1_9', 'komegasst_I1_3', 'komegasst_I1_4', 'komegasst_I1_16'],
}
