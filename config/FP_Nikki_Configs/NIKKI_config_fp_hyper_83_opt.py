...
run_name = 'kan_experiment_83_opt'
results_dir = '/home/nikki/kan/kanTBNN/models/multi_run/kan_experiment_83_opt'
...
training_params = {
    ...
    'max_epochs': 8000,
    'learning_rate': 0.0011884193033864527,
...
model_params = {
    ...
    'grid': 10,
    'k': 3,
    'input_features': ['komegasst_I1_12', 'komegasst_I1_3', 'komegasst_I1_9', 'komegasst_I1_13', 'komegasst_q5', 'komegasst_q6'],
}
