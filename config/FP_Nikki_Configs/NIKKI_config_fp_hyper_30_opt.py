...
run_name = 'kan_experiment_30_opt'
results_dir = '/home/nikki/kan/kanTBNN/models/multi_run/kan_experiment_30_opt'
...
training_params = {
    ...
    'max_epochs': 8000,
    'learning_rate': 0.0009028388513655931,
...
model_params = {
    ...
    'grid': 10,
    'k': 3,
    'input_features': ['komegasst_I1_1', 'komegasst_q5', 'komegasst_q6', 'komegasst_I1_4', 'komegasst_I1_12', 'komegasst_I1_9'],
}
