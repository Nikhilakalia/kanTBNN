...
run_name = 'kan_experiment_149_opt'
results_dir = '/home/nikki/kan/kanTBNN/models/multi_run/kan_experiment_149_opt'
...
training_params = {
    ...
    'max_epochs': 8000,
    'learning_rate': 0.0049931195154008234,
...
model_params = {
    ...
    'grid': 8,
    'k': 3,
    'input_features': ['komegasst_I1_1', 'komegasst_I1_7', 'komegasst_I1_16', 'komegasst_q6', 'komegasst_q5', 'komegasst_I1_4'],
}
