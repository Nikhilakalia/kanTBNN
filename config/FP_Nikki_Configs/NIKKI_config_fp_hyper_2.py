...
run_name = 'kan_experiment_2'
results_dir = '/home/nikki/kan/kanTBNN/models/multi_run/kan_experiment_2'
...
model_params = {
    ...
    'grid': 3,
    'k': 3,
    'input_features': ['komegasst_I1_7', 'komegasst_I1_12', 'komegasst_I1_9', 'komegasst_I1_5', 'komegasst_I1_4', 'komegasst_q5'],
}
