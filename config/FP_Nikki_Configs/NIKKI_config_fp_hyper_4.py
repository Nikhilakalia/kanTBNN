...
run_name = 'kan_experiment_4'
results_dir = '/home/nikki/kan/kanTBNN/models/multi_run/kan_experiment_4'
...
model_params = {
    ...
    'grid': 4,
    'k': 3,
    'input_features': ['komegasst_I1_3', 'komegasst_q6', 'komegasst_I1_9', 'komegasst_I1_12', 'komegasst_q5', 'komegasst_I1_4'],
}
