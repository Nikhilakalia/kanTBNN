...
run_name = 'kan_experiment_9'
results_dir = '/home/nikki/kan/kanTBNN/models/multi_run/kan_experiment_9'
...
model_params = {
    ...
    'grid': 5,
    'k': 3,
    'input_features': ['komegasst_I1_4', 'komegasst_I1_13', 'komegasst_I1_12', 'komegasst_I1_3', 'komegasst_q5', 'komegasst_q6'],
}
