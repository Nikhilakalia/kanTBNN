...
run_name = 'kan_experiment_99_opt'
results_dir = '/home/nikki/kan/kanTBNN/models/multi_run/kan_experiment_99_opt'
...
training_params = {
    ...
    'max_epochs': 8000,
    'learning_rate': 0.00865760946501738,
...
model_params = {
    ...
    'grid': 3,
    'k': 3,
    'input_features': ['komegasst_q6', 'komegasst_I1_1', 'komegasst_I1_3', 'komegasst_q5', 'komegasst_I1_12', 'komegasst_I1_4'],
}
