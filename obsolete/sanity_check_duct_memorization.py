...
sys.stdout = open(f'models/duct_memorization/model_{model.__class__.__name__}_{model_params["n_hidden"]}x{model_params["neurons"]}.log','w')
...
ax.semilogy()
fig.tight_layout()
fig.savefig(f'models/duct_memorization/model_{model.__class__.__name__}_{model_params["n_hidden"]}x{model_params["neurons"]}.png',dpi=300)
...
fig.savefig(f'models/duct_memorization/model_{model.__class__.__name__}_{model_params["n_hidden"]}x{model_params["neurons"]}_b_test.png',dpi=300)
...
fig.savefig(f'models/duct_memorization/model_{model.__class__.__name__}_{model_params["n_hidden"]}x{model_params["neurons"]}_a_test.png',dpi=300)
...
endtime = '0'
foamdir = '/home/ryley/WDK/ML/scratch/injection/squareDuct_Re_2000_memorization'
...
torch.save(model.state_dict(), f'models/duct_memorization/duct_memorization.state_dict')

with open(f"models/duct_memorization/params_cluster_duct_memorization.pickle", 'wb') as handle:
