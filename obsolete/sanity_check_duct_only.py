...
model_params = {'neurons': 30, 'n_hidden': 8, 'activation_function': nn.SiLU(),                 
                'input_features':[
#'komegasst_q2',
'komegasst_q5',
'komegasst_q6',
...
sys.stdout = open(f'models/duct_only/model_{model.__class__.__name__}_{model_params["n_hidden"]}x{model_params["neurons"]}.log','w')
...
endtime = '0'
foamdir = '/home/ryley/WDK/ML/scratch/injection/squareDuct_Re_2000_duct_only'
...
with open(f"models/duct_only/params_cluster_duct_only.pickle", 'wb') as handle:
