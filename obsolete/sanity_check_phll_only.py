...
model_params = {'neurons': 40, 'n_hidden': 7, 'activation_function': nn.SiLU(),                 
                'input_features':[
'komegasst_q6',
'komegasst_q5',
'komegasst_q8',
...
sys.stdout = open(f'models/phll_only/model_{model.__class__.__name__}_{model_params["n_hidden"]}x{model_params["neurons"]}.log','w')
...
ax.semilogy()
fig.tight_layout()
fig.savefig(f'models/phll_only/model_{model.__class__.__name__}_{model_params["n_hidden"]}x{model_params["neurons"]}.png',dpi=300)
...
fig.savefig(f'models/phll_only/model_{model.__class__.__name__}_{model_params["n_hidden"]}x{model_params["neurons"]}_b_test.png',dpi=300)
...
fig.savefig(f'models/phll_only/model_{model.__class__.__name__}_{model_params["n_hidden"]}x{model_params["neurons"]}_a_test.png',dpi=300)
...
endtime = '0'
foamdir = '/home/ryley/WDK/ML/scratch/injection/case_1p2_phll_only'
...
torch.save(model.state_dict(), f'models/phll_only/phll_only.state_dict')

with open(f"models/phll_only/params_cluster_phll_only.pickle", 'wb') as handle:
