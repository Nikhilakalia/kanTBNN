...
sys.stdout = open(f'models/fp_memorization/model_{model.__class__.__name__}_{model_params["n_hidden"]}x{model_params["neurons"]}.log','w')
...
ax.semilogy()
fig.tight_layout()
fig.savefig(f'models/fp_memorization/model_{model.__class__.__name__}_{model_params["n_hidden"]}x{model_params["neurons"]}.png',dpi=300)
...
fig.savefig(f'models/fp_memorization/model_{model.__class__.__name__}_{model_params["n_hidden"]}x{model_params["neurons"]}_b_test.png',dpi=300)
...
fig.savefig(f'models/fp_memorization/model_{model.__class__.__name__}_{model_params["n_hidden"]}x{model_params["neurons"]}_a_test.png',dpi=300)
